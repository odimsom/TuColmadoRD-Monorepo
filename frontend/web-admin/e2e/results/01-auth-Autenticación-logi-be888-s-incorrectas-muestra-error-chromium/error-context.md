...
- Name: 01-auth.spec.ts >> Autenticación >> login con credenciales incorrectas muestra error
- Location: e2e/01-auth.spec.ts:21:7
...
Locator: locator('[data-testid="login-error-alert"]')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="login-error-alert"]')
    ...
    - generic [ref=e49]:
      ...
      - generic [ref=e53]:
        - generic [ref=e54]:
          ...
          - textbox "tu@colmado.com" [ref=e57]: malo@test.com
        - generic [ref=e58]:
          - generic [ref=e59]: Contraseña
          - textbox "••••••••" [ref=e61]: wrongpass
